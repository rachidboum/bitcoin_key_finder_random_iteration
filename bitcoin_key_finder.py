...
r = 0
cores = multiprocessing.cpu_count()  #CPU Control Set Cores
...
def seek(r):
    ...
    while P<y:
            ...
            if uaddr in add:
                ...
                colour_reset = '\033[0;0;39m'
                colour_red = '\033[31m'
                total_iterations = y - x
                iterations_per_sec = cores * 100
                estimated_time_sec = total_iterations / iterations_per_sec
                estimated_time_min = estimated_time_sec / 60
                print(f"Estimated time: {estimated_time_min:.2f} minutes still searching")
                print (colour_cyan + seconds_to_str() + colour_red + "Still searching" + colour_cyan + myhex, end='\r'  + colour_reset) # Running Display Output
